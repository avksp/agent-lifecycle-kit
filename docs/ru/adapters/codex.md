...
а основной проверенный диапазон адаптера остаётся `0.145.0`. См.
...
Команда создаёт входные артефакты ALK. Для запуска Codex добавьте
квалифицированный профиль и `--launch`; подтверждение жизненного цикла
