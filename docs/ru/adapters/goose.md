...
Встроенная проекция Goose не устанавливает модуль или навык ALK внутрь
внешнего инструмента. Используйте команду либо отдельную проверенную обвязку,
которая вызывает те же команды ALK:
...
По умолчанию команда не запускает Goose. Подробнее: [использование ALK с
