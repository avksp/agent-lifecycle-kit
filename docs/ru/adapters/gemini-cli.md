...
Gemini CLI умеет находить навыки, но встроенный адаптер не меняет каталог
навыков внешнего инструмента. Подключите общий каталог `skills/` из отмеченной
версии через штатные настройки Gemini CLI и запросите
`agent-workflow-orchestrator` либо используйте поддерживаемую команду:
...
умолчанию она не запускает Gemini CLI. Подробнее: [использование ALK с
