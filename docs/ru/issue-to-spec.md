...
Если тикет описывает ошибку, черновик может рекомендовать дополнительный
профиль расследования ошибок, но воспроизведение и подтверждения исправления
всё равно принадлежат проверенному плану.
