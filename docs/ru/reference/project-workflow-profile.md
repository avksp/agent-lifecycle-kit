...
Профиль принадлежит проекту, который его использует. Обычно он хранится в
исключённом из Git файле `.alk/project-profile.json` и не заменяет
спецификацию, зафиксированный план или lock-файл плана.
