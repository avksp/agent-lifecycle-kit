...
**Лицензия:** Apache-2.0 · **Версия:** 1.55.0 · **Python:** 3.11-3.14

## Быстрый старт
Официальный [пакет в PyPI](https://pypi.org/project/agent-lifecycle-kit/) для Python 3.11-3.14: `python -m pip install agent-lifecycle-kit==1.55.0`.
Из исходного дерева:
