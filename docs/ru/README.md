...
- Старт: [Быстрый старт](quickstart.md), [сценарии проверки кода](code-review-workflows.md), [практические сценарии групповой проверки](review-mesh-workflow.md) и [черновик спецификации из тикета](issue-to-spec.md).
