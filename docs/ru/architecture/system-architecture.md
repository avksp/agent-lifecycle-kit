...
- При проверке несколькими рецензентами ALK готовит назначения, импортирует
...
Проверка несколькими рецензентами применяется к черновику ведущего,
параллельному исследованию или аудиту реализации. ALK создаёт пакеты заданий и
проверяет импортированные результаты, но не запускает рецензентов. Кворум
