...
DOC_RULES: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    (
        ...
        (
            ...
            "reference/project-workflow-profile.md",
            "project profile init",
            "https://pypi.org/project/agent-lifecycle-kit/",
            "Python 3.11-3.14",
            "agent-lifecycle start --adapter",
    ...
    (
        ...
        (
            ...
            "NO_COMPARISON",
            "29,195,208",
            "Release 2.12 delta-audit baseline",
            "FULL_AUDIT",
        ),
    ),
    (
        ...
        (
            ...
            "NO_COMPARISON",
            "29,195,208",
            "baseline дельта-аудита Release 2.12",
            "FULL_AUDIT",
        ),
    ),
    (
    ...
    (
        ...
        (
            ...
            "validate_publication_versions.py",
    ...
    (
        ...
        (
            ...
            "OpenCode/GLM",
            "Any available combination is valid",
            "If no alternative model is available",
    ...
    (
        ...
        (
            ...
            "OpenCode/GLM",
            "Допустимы любые доступные сочетания",
            "Если другой модели нет",
            "становится обязательным только для этапов",
            "не запускает модели",
    ...
    (
        ...
        (
            ...
            "--project-profile",
            "--no-project-profile",
            "frozen plan and matching lock",
            "provider, account, credential, secret",
        ),
    ),
    (
        ...
        (
            ...
            "--project-profile",
            "--no-project-profile",
            "зафиксированный план и соответствующий lock-файл",
            "провайдере, аккаунте, учётных данных",
        ),
    ),
    (
    ...
    (
        ...
        (
            ...
            "shell-free",
            "Ordinary workflows do not allocate external-job state",
            "provider client",
        ),
    ),
    (
        ...
        (
            ...
            "cancelGraceSeconds * 3",
            "без оболочки",
            "Обычный workflow не создаёт состояние внешнего задания",
            "клиента провайдера",
        ),
    ),
    (
    ...
    (
        ...
        (
            ...
            "route through a verified profile",
    ...
    (
        ...
        (
            ...
            "several independent AI models",
            "different adapter/model binding",
            "any available bindings",
            "Multiple sessions of one model",
            "never mandatory by installation",
            "review-mesh prepare",
            ...
            "NO_FINAL_VERDICT",
            "Reviewer text never becomes argv",
        ),
    ),
    (
        ...
        (
            ...
            "parallel-research-synthesis",
            "implementation-audit-panel",
            "несколькими моделями ИИ",
            "отдельную связку адаптера и модели",
            "любые доступные",
            "Несколько сеансов одной модели",
            "не делают Review Mesh обязательным",
            "review-mesh prepare",
            ...
            "agent-finding-disposition.v1",
            "NO_FINAL_VERDICT",
            "Текст проверяющего никогда не становится argv",
        ),
    ),
    (
