...
class ContractCompatibilityTests(unittest.TestCase):
    def test_public_contract_policy_validates_current_registry(self) -> None:
        ...
        self.assertIn("agent-thread-capability.v1", schema_ids)
        self.assertIn("agent-thread-operation-request.v1", schema_ids)
        self.assertIn("agent-thread-operation-receipt.v1", schema_ids)
        self.assertIn("agent-thread-context-import.v1", schema_ids)
        self.assertIn("agent-thread-operation-validation.v1", schema_ids)
        ...
        self.assertIn(("audit package", "agent-plan-package-audit-report.v1"), cli_outputs)
        ...
        self.assertIn(("thread request", "agent-thread-operation-request.v1"), cli_outputs)
        self.assertIn(("thread import", "agent-thread-context-import.v1"), cli_outputs)
