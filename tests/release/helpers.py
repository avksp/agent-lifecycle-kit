...
def _write_live_host_promotion_plan_fixture(package_root: Path) -> Path:
        ...
        workstreams.append(
            {
                ...
                "evidence": [
                    f"work/release-0-5/evidence/live-host-receipts/{host}.json",
                    f"work/release-0-5/evidence/live-calibration/{host}.json",
                    f"work/release-0-5/evidence/live-host-conformance-{host}.json",
                    f"work/release-0-5/evidence/live-calibration-verification-{host}.json",
                    f"work/release-0-5/evidence/live-promotion-audit-{host}.json",
                ],
            }
        )
    ...
    plan = {
        ...
        "evidenceRoot": "work/release-0-5/evidence",
        "hostOrder": hosts,
        ...
        "validationCommands": [
            {
                ...
                "argv": "PYTHONPATH=src python tools/release/validate_live_host_promotion_plan.py --plan work/release-0-5/patches/0.5.0-claude-live-promotion/host-promotion.plan.json --evidence work/release-0-5/evidence/live-host-promotion-plan-validation.json",
            }
        ],
        "evidenceArtifacts": [
            {
                ...
                "path": "work/release-0-5/evidence/live-host-promotion-plan-validation.json",
            }
        ],
        "sharedNonGoals": [],
