"""Bounded Qwen Code stream-json usage normalizer."""
...
def _normalized(usage: dict[str, Any], session_id: str | None, tool_calls: int, wall_seconds: float, event_count: int) -> NormalizedUsage:
    input_tokens = _counter(usage, ("inputTokens", "input_tokens", "prompt_tokens", "promptTokens"))
    output_tokens = _counter(usage, ("outputTokens", "output_tokens", "completion_tokens", "completionTokens"))
    total_tokens = _counter(usage, ("billableTokens", "billable_tokens", "total_tokens", "totalTokens"))
