"""Shared lifecycle-mode ordering without a dependency on policy or metrics."""
...
def max_mode(*modes: str | None) -> str:
    ...
    return max(valid, key=mode_index) if valid else "standard"
...
def resolve_quality_floor(
    *,
    ...
    """Build the deterministic floor without importing the policy package."""
